...
const deleteCart = async (req, res) => {
    try {
        ...
        console.log('Ocurrio el siguiente error al querer eliminar el carrito', error)
        res.sendStatus(500);
    }
}
...
//export
export { getNewCart, deleteCart, getCartProducts, postProductToCart, deleteProductFromCart };