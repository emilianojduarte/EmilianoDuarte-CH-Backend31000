                        ...
                        <form id="msgForm" autoComplete="off" className="col-12" onSubmit={handleSubmitMsg}>
                            <div className="mb-3 row">
                                <div className="col-6">
                                    ...
                                    <input id="usernameInput" type="email" className="form-control" placeholder="Ingrese una dirección de correo electrónico" 
                                        name="username" required value={usuario} onChange={(e)=> setUsuario(e.target.value)}
                                    />
                                </div>
                                <div className="col-6">
